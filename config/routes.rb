ROCCIServer::Application.routes.draw do
  ...
  post '/compute/:id', to: 'compute#trigger', constraints: { action: /^\S+$/ }
  post '/compute/:id', to: 'compute#update', as: 'update_compute'
  post '/compute/', to: 'compute#trigger', constraints: { action: /^\S+$/ }
  ...
  post '/network/:id', to: 'network#trigger', constraints: { action: /^\S+$/ }
  post '/network/:id', to: 'network#update', as: 'update_network'
  post '/network/', to: 'network#trigger', constraints: { action: /^\S+$/ }
  ...
  post '/storage/:id', to: 'storage#trigger', constraints: { action: /^\S+$/ }
  post '/storage/:id', to: 'storage#update', as: 'update_storage'
  post '/storage/', to: 'storage#trigger', constraints: { action: /^\S+$/ }
  ...
  post '/mixin/os_tpl/(:term/)', to: 'os_tpl#trigger', constraints: { action: /^\S+$/ }
  ...
  post '/mixin/resource_tpl/(:term/)', to: 'resource_tpl#trigger', constraints: { action: /^\S+$/ }
  ...
  post '/mixin/*term/', to: 'mixin#trigger', constraints: { action: /^\S+$/ }
