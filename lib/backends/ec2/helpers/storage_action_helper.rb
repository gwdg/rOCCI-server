  ...
  module Ec2
    module Helpers
      module StorageActionHelper
        def trigger_action_snapshot(storage_id, attributes = ::Occi::Core::Attributes.new)
          trigger_action_state_check(storage_id, 'http://schemas.ogf.org/occi/infrastructure/storage/action#snapshot')
        ...
        def trigger_action_state_check(storage_id, action_type_identifier)
          result = get(storage_id)
