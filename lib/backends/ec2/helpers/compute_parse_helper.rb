    ...
    module Helpers
      module ComputeParseHelper
        ...
        def parse_backend_obj(backend_compute, reservation_id)
          ...
          res_tpl_mixin = get_resource_tpl(itype_to_term(backend_compute[:instance_type]))
          if res_tpl_mixin
            compute.mixins << res_tpl_mixin
            compute.attributes['occi.compute.cores'] = res_tpl_mixin.attributes.occi_.compute_.cores.default
            compute.attributes['occi.compute.memory'] = res_tpl_mixin.attributes.occi_.compute_.memory.default
          else
